...
public abstract class CertificateCoder extends Coder {
	 ...
	 * @throws Exception
	 */
	public static Certificate getCertificate(String keyStorePath, String alias,
			String password) throws Exception {
		KeyStore ks = getKeyStore(keyStorePath, password);
	 ...
	 * @throws Exception
	 */
	public static byte[] sign(byte[] data, String sigAlgName,
	...
	public static boolean verify(byte[] data, String sign, PublicKey publicKey,
		...
		signature.initVerify(publicKey);
		signature.update(data);
		return signature.verify(HexCodec.hexDecode(sign));
