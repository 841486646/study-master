...
public class TestMail {
    ...
    // 发件人的邮箱地址和密码
    public static String sendEmailAccount = "386869957@qq.com";
    //如果有授权码，此处填写授权码
    public static String sendEmailPassword = "vccanzhkrbgacaig";

    // 发件人邮箱的 SMTP 服务器地址, 可以登录web邮箱查询
    public static String sendEmailSMTPHost = "smtp.qq.com";

    // 收件人邮箱地址
    public static String receiveMailAccount = "841486646@qq.com";
