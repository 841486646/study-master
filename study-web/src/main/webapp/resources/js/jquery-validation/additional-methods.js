...
$.validator.addMethod("validateIdcard", function(idcard, element) {
	idcard=""+idcard;
	if(!idcard){
		return null;
	}
...
$.validator.addMethod("validateFundPassword", function(value, element) {
	var v_regex=/^\d{6}$/;
	value=""+value;
	if(value){
		if(!v_regex.test(value)){
...
$.validator.addMethod("validateNumber4Fund", function(value, element) {
	var v_regex=/^\d{1,}(\.\d{1,2}){0,1}$/;
	value=""+value;
	if(value){
		if(!v_regex.test(value)){
			return false;
